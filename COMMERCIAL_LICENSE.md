# Commercial License — SyncPlay

> Replaces: Photon Engine ($95–$370/mo for 500-2000 CCU), PlayFab ($0.02/MAU), AWS GameLift.
> SyncPlay synchronizes multiplayer game state via P2P WebRTC with host-authority model and JSON Patch deltas.

## Pricing

| Tier | Price | What You Get |
|:-----|:------|:-------------|
| **Indie** | $349/year | 1 developer, 1 game, up to 500 CCU |
| **Startup** | $2,499/year | Up to 10 developers, 3 games, up to 10,000 CCU |
| **Enterprise** | $12,999/year | Unlimited developers, unlimited games, unlimited CCU, priority support |
| **Platform / OEM** | $24,999/year | White-label, embed in your game engine, redistribute |
| **Full IP Buyout** | $1,000,000 | Complete intellectual property transfer |

### Why This Pricing?

A multiplayer game with 5,000 CCU:
- **Photon Enterprise**: ~$1,500–$3,000/month ($18K–$36K/year)
- **AWS GameLift**: ~$2,000/month ($24K/year)
- **SyncPlay Enterprise**: $12,999/**year** (saving $5K–$23K/year + zero server bandwidth)
